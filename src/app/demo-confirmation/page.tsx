      ...
      <div className="row justify-content-center">
        <div className="col-md-8 col-lg-6 text-center">
          <div className="card shadow p-5">
            ...
            <p className="lead mb-4">Your demo class has been scheduled successfully.</p>
            
            <div className="mb-4 p-3 bg-light rounded">
              <p className="mb-1">We'll contact you soon to confirm your booking details.</p>
              <p className="small text-muted mb-0">
                If you have any questions, please contact us at <a href="mailto:info@dancestudio.com" className="text-decoration-none">info@dancestudio.com</a>
              </p>
            </div>
            ...
            <div className="d-grid gap-2">
              ...
              <Link href="/schedule-demo" className="btn btn-outline-secondary">
          ...
          <div className="mt-4">
            <p className="small text-muted">
              Want to become a regular student? <Link href="/login" className="text-primary">Sign up here</Link>
            </p>
          </div>
        </div>
      </div>
